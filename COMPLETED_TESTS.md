...
5. **Profil- und BerechtigungsauflÃ¶sung nach RLS-Fehler getestet**
...
10. **Direkte Eingabe in die Zeitraeder getestet**
    Ergebnis: Bestaetigt. Nach der Anpassung ueberlagerte die Zahlentastatur die Raeder nicht mehr; der Nutzer bestaetigte das Verhalten mit â€žtopâ€œ.
...
31. **Anzeige der Gruppenkurs-Alternativen getestet**
    Ergebnis: Bestaetigt. Der Test wurde bis zur Liste der verfuegbaren Alternativtermine durchgefuehrt; der Nutzer bestaetigte â€žAlles korrektâ€œ.
